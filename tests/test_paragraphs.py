...
def test_renders_content_distinguishes_prose_citation_only_and_code():
    ...
    both `report._answer_section` (dropping empty blocks) and `verify._format_verdicts_block`
    (the reviewer paragraph's numbering) — pinned directly so a change to it is a deliberate
